...
function AllNews() {
  ...
  return (
    <>
      <div className='my-10 cards grid lg:place-content-center md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 xs:grid-cols-3 xs:gap-4 md:gap-10 lg:gap-14 md:px-16 xs:p-3 '>
